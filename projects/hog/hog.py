...
def swine_align(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4a
    "*** YOUR CODE HERE ***"
    return True if get_gcd(player_score, opponent_score) >= 10 else False
    # END PROBLEM 4a
...
def pig_pass(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4b
    "*** YOUR CODE HERE ***"
    return True if (0 < opponent_score - player_score < 3) else False
    # END PROBLEM 4b
...
def get_goal(score0, score1, goal):
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 5
    "*** YOUR CODE HERE ***"
    while not get_goal(score0, score1, goal):
        if who == 0:
            num_rolls = strategy0(score0, score1)
            score0 += take_turn(num_rolls, score1, dice)
            say = say(score0, score1)
            while extra_turn(score0, score1) and not get_goal(score0, score1, goal):
                num_rolls = strategy0(score0, score1)
                score0 += take_turn(num_rolls, score1, dice)
                say = say(score0, score1)
        else:
            ...
            say = say(score0, score1)
            while extra_turn(score1, score0) and not get_goal(score0, score1, goal):
                num_rolls = strategy1(score1, score0)
                score1 += take_turn(num_rolls, score0, dice)
                say = say(score0, score1)
        who = other(who)
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    max_average, flag = 0, 0
    for i in range(1, 11):
        num = make_averaged(roll_dice, trials_count)(i, dice)
        if num > max_average:
            max_average = num
            flag = i
    return flag
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    return 0 if extra_turn(score, opponent_score) else bacon_strategy(score, opponent_score, cutoff, num_rolls)
    # END PROBLEM 11
